...
/*!
    ...
    This is a library for the Adafruit ADS1x15 breakout board
...
/*=========================================================================
    ...
    #define ADS1x15_VOLTS_PER_BIT_GAIN_TWOTHIRDS   0.003F
    #define ADS1x15_VOLTS_PER_BIT_GAIN_ONE         0.002F 
    #define ADS1x15_VOLTS_PER_BIT_GAIN_TWO         0.001F  
    #define ADS1x15_VOLTS_PER_BIT_GAIN_FOUR        0.0005F   
    #define ADS1x15_VOLTS_PER_BIT_GAIN_EIGHT       0.00025F  
    #define ADS1x15_VOLTS_PER_BIT_GAIN_SIXTEEN     0.000125F 
/*=========================================================================*/
...
typedef enum : uint16_t
{
    ADS1x15_DR_128SPS          = ADS1x15_REG_CONFIG_DR_128SPS,
    ADS1x15_DR_250SPS          = ADS1x15_REG_CONFIG_DR_250SPS,
    ADS1x15_DR_490SPS          = ADS1x15_REG_CONFIG_DR_490SPS,
    ADS1x15_DR_920SPS          = ADS1x15_REG_CONFIG_DR_920SPS,
    ADS1x15_DR_1600SPS         = ADS1x15_REG_CONFIG_DR_1600SPS,  // default for ADS1x15
    ADS1x15_DR_2400SPS         = ADS1x15_REG_CONFIG_DR_2400SPS,
    ADS1x15_DR_3300SPS         = ADS1x15_REG_CONFIG_DR_3300SPS,
	...
	DR_DEFAULT_SPS             = (ADS1115_REG_CONFIG_DR_128SPS)     // 1600 for ADS1x15, 128 for ADS1115
} adsSPS_t;
...
public:
	ADS1x15(uint8_t i2cAddress = ADS1X15_ADDRESS, uint8_t bitsShift = ADS1115_CONV_REG_BIT_SHIFT_0);
	void begin(void);
